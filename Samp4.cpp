...
int main(){
	...
	//initscr();
	char InputStr[]= "cycle is bottom the girl.cycle is to the right of tree.cycle is bottom the tree.girl is top the cycle.girl is to the right of tree.girl is bottom the tree.tree is to the left of cycle.tree is top the cycle.tree is to the left of girl.tree is top the girl.";
